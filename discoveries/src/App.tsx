...
import PioneerEditPage from "./pages/PioneerEditPage/PioneerEditPage";
import PioneerAddPage from "./pages/PioneerAddPage/PioneerAddPage";
...
const TopPanelWrapper = () => {
    ...
    return (
        <div className="top-panel-wrapper">
            <Breadcrumbs />
            {is_authenticated && !is_moderator && description.pathname.endsWith("pioneers") && <DiscoveryConstructor /> }
        </div>
    )
}
                        ...
                        <div className="wrapper">
                            ...
                            <div className={"content-wrapper"}>
                                ...
                                <Routes>
                                    ...
                                    <Route path="/pioneers/add" element={<PioneerAddPage />} />

                                    <Route path="/pioneers/:id" element={<PioneerPage />} />

                                    <Route path="/pioneers/:id/edit" element={<PioneerEditPage />} />
